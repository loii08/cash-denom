...
export const VERSION_NOTES: Record<string, string> = {
  '1.2.21': 'Auto-incremented version',
  '1.2.20': 'Auto-incremented version',
  '1.2.19': 'Auto-incremented version',
  '1.2.18': 'Auto-incremented version',
  '1.2.17': 'Auto-incremented version',
  '1.2.16': 'Auto-incremented version',
  '1.2.15': 'Auto-incremented version',
  '1.2.14': 'Auto-incremented version',
  '1.2.13': 'Auto-incremented version',
  '1.2.12': 'Auto-incremented version',
  '1.2.11': 'Auto-incremented version',
  '1.2.10': 'Auto-incremented version',
  '1.2.9': 'Auto-incremented version',
  '1.2.8': 'Auto-incremented version',
  '1.2.7': 'Auto-incremented version',
  '1.2.6': 'Auto-incremented version',
  '1.2.5': 'Auto-incremented version',
  '1.2.4': 'Auto-incremented version',
  '1.2.3': 'Auto-incremented version',
